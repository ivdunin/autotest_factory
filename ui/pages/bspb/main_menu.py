...
class MainMenu(BasePage):
    menu_elements: PageElements = PageElements(by_css('ul.navigation-menu.nav > li'))
    accounts_menu: PageElement = PageElement(by_id('accounts'))
    statement_menu: PageElement = PageElement(by_id('statement'))
